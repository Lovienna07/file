...
class_labels = ['Alton', 'Andrew', 'Bella', 'Bosen', 'Cia-cia', 'Clarissa', 'Derrick', 'Edward', 'Eric 高嘉澤', 'Ian', 'Indakananda Putta - 许泰铭', 'Kenneth', 'Logan', 'Louis', 'Lovie', 'Matthew 陳偉君', 'Morgan李世祈', 'Raphael', 'Renan 夏俊雄', 'Selena', 'Stephanie 溫欣如', 'Vincent', 'Wilbert']
